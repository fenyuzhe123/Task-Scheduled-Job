...
#===================================================================================#
set-location D:\schedule_jobs\UCSWEEKLY
$UCS = @{}
$UCS_Creds = @{}
$CCO_Creds = $null
$CCO_Image_List = $null
...
$runspaces = $null
$Silent_Path = 'D:\schedule_jobs\UCSWEEKLY'
$Silent_FileName = 'SOI_UCS_WEEKLY_Report_' + (Get-Date -format MM_dd_yyyy) + '.html'
...
$mailto = "shayne.niu@activenetwork.com"
#--- HTML Markup ---#
#===================================================================================#
# 	Variable Definition:															#
...
function Generate_Health_Check
{
	...
	{ 
		7z a -tzip "$OutputFile`.zip" $OutputFile
		sleep 8
		$msg = new-object Net.Mail.MailMessage
		$att = new-object Net.Mail.Attachment("$OutputFile`.zip")
