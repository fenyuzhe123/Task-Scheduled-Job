...
$Title = "Floppies Connected"
$Header = "VM: Floppy Drive Connected - VMotion Violation: $(@($Result).Count)"
$Comments = "The following VMs have a floppy drive connected, this may cause issues if this machine needs to be migrated to a different host"
$Display = "Table"
