	...
	<body style="padding: 0 10px; margin: 0px; font-family:Arial, Helvetica, sans-serif; ">
      <a name="top" />
        <table width='100%' style='background-color: black; margin: 0; padding: 0;'>
         <tr>
            <td style='background-color: #545456;'>
...
$PluginHTML = @"
	<!-- Plugin Start - _TITLE_ -->
      <div style='height: 10px; font-size: 10px;'>&nbsp;</div>
      <a name="_PLUGINID_" />
      <table width='100%' style='padding: 0px; border-collapse: collapse;'><tr><td style='background-color: #1d6325; border: 1px solid #1d6325; font-family: Tahoma, sans-serif; font-weight: bold; font-size: 9pt; color: #FFFFFF; text-indent: 10px; height: 30px; vertical-align: middle;'>_TITLE_</td></tr>
